    ...
    <div className="font-main">
      ...
      <div className="border border-gray-400 rounded-xl p-3 mx-3 ">
        <div className="font-semibold text-2xl">
          <Checkbox crossOrigin="anonymous" color="blue" checked={checkEntireApprove} onChange={handleCheckAll} />
          전체 동의
        </div>
        <hr />
        <div className="text-gray-700 text-lg mt-3">
          <Checkbox color="blue" checked={check1} onChange={handleCheck1} crossOrigin="anonymous" />
          [필수] 통합자산관리서비스 이용약관
        </div>
        <div className="text-gray-700 text-lg mt-3">
          <Checkbox color="blue" checked={check2} onChange={handleCheck2} crossOrigin="anonymous" />
          [필수] 통합자산관리서비스 설명서
        </div>
        <div className="text-gray-700 text-lg mt-3">
          <Checkbox color="blue" checked={check3} onChange={handleCheck3} crossOrigin="anonymous" />
          [필수] 개인(신용)정보 수집•이용 동의서 (통합자산관리서비스)
        </div>
      </div>

      <div className="bg-gray-300 mt-5 mx-3 p-3 border rounded-lg text-md">
        <div className="mb-2">내 정보를 안전하게 지키는 마이데이터 사용법</div>
        <div>
          • 가입하기 전에 한번 더 고민해주세요.
          <br />
          • 꼭 필요한 서비스만 가입해주세요.
          <br />• 잘 이용하지 않는 서비스는 탈퇴 후 삭제해주세요
        </div>
      </div>

      <div className="mx-3 mt-5 text-gray-500">
        * 태산은 마이데이터를 통해 수집된 정보를 저장하지 않습니다.
        <br />
        * 무분별한 마이데이터 서비스 가입으로 나의 개인정보가 너무 많은 곳에 전송, 보관될 수 있습니다.
        <br />
