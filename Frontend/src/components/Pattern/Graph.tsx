...
const Graph = () => {
  ...
  const analyzePlace = () => {
    axios
      .post(
        `https://j9c211.p.ssafy.io/api/analyst-management/analysts/place/analyst`,
        {
          month: month,
          year: year,
        },
  ...
  const analyzeReceipt = () => {
    axios
      .post(
        `https://j9c211.p.ssafy.io/api/analyst-management/analysts/receipt/analyst`,
        {
          month: month,
          year: year,
        },
  ...
  return (
    <div className="mx-4 mt-11 mb-28 dt:mt-5 dt:mb-0">
      <div className="dt:flex dt:ml-11 dt:gap-9">
        <div>
          <div className=" font-bold text-blue-gray-600">설정기간</div>
        ...
        <div className="dt:w-[23%]">
          <div className=" font-bold text-blue-gray-600 my-2">카테고리 분류</div>
      ...
      {data && data.length > 0 ? (
              ...
              {data.map((res, index) => (
                <div key={index} className="flex items-center h-[16px] my-5 w-[90%] justify-between">
                  <div className="flex gap-4 items-center">
                    <div
                      style={{
                        backgroundColor: colortag[index % 12],
                        height: '10px',
                        width: '10px',
                        marginRight: '5px',
                      }}
                    ...
                    <Typography
                      variant="h6"
                      color="blue-gray"
                      className="font-normal text-end text-m font-bold text-xl"
                    >
                      {res.id}
                    </Typography>
                  </div>
                  <div className="flex gap-4">
                    <Typography
                      variant="h6"
                      color="blue-gray"
                      className="font-normal text-end text-m font-bold text-blue-gray-500 text-xl"
                    >
        ...
        <div className="w-full flex justify-center items-center h-48">
          {tagnum === 0 ? (
            <Typography variant="h4" color="black" className="w-fit">
              소비내역이 없어요
            </Typography>
          ) : (
            <Typography variant="h4" color="black" className="w-fit">
