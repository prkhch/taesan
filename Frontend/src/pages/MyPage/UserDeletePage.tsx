  ...
  return (
    <div>
      ...
      <div className="h-screen flex flex-col  justify-center mx-10 space-y-3 font-main mt-10 ">
        ...
        <div className="dt:text-lg">
          <span style={{ color: '#059669' }}>{name}</span>님께서 회원 탈퇴를 원하신다니 저희 '태산 : 泰山'의 서비스가
          많이 부족하고 미흡했나 봅니다. 불편하셨던 점이나 불만사항을 알려주시면 적극 반영해서 고객님의 불편함을 해결해
          드리도록 노력하겠습니다.
        </div>
        <br />
        ...
        <div className="dt:text-lg">
          • '태산 : 泰山' 회원 탈퇴시 '태산 : 泰山' 서비스에 탈퇴되며 사용하고 계신 아이디는 복구가 절대 불가능합니다.{' '}
        </div>
        <div className="dt:text-lg">
          • '태산 : 泰山' 회원 탈퇴시 회원님의 '샀다 치고' 목록, 등록한 영수증, 참가중인 절약 챌린지 정보,{' '}
          <span style={{ color: '#059669' }}>{name}</span>님의 소비 패턴과 같은 개인정보들은 모두 삭제되며, 삭제된
          데이터는 복구가 불가능합니다. 다만 법령에 의하여 보관해야 하는 경우 또는 회원가입 남용, 서비스 부정사용 등을
          위한 회사 내부정책에 의하여 보관해야하는 정보는 회원탈퇴 후에도 일정기간 보관됩니다. 자세한 사항은 태산
